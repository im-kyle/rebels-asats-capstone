...
exports.seed = async function(knex) {
  ...
  await knex('units').insert([
    ...
    {office_symbol: 'DAU', name: '45 CYS', street_address: '180 W Skid Strip Rd', base: 'Patrick AFB', state: 'FL', zipcode: 32925, cc_user_id: null},
    {office_symbol: 'CYD', name: '62 CYS', street_address: '555 Freedom Ave', base: 'Buckley SFB', state: 'CO', zipcode: 80011, cc_user_id: null}
  ]);
};
