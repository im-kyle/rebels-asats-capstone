...
exports.seed = async function(knex) {
  ...
  await knex('users').insert([
    ...
    {fb_uid: 'Q4lxq4dmm3cNEXifVnDKbHnSDi32', first_name: 'Allie', last_name: 'Zhang', middle_initial: 'Q', rank_grade: 'Spc4', rank_category: 'JE', afsc_id: 7, duty_title: 'Military Training Leader', majcom_foa_dru: 'DEL 13', phone_dsn: '555-5555', phone_comm: '555-555-5555', unit_id: 4, is_admin: true},
    {fb_uid: 'LIAwS2MosCWWs4QV6S6Css7C8tZ2', first_name: 'John', last_name: 'Doe', middle_initial: 'H', rank_grade: 'Spc3', rank_category: 'JE', afsc_id: 7, duty_title: 'Military Training Leader', majcom_foa_dru: 'DEL 13', phone_dsn: '555-5555', phone_comm: '555-555-5555', unit_id: 4, is_admin: true},
